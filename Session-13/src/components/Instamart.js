  ...
  return (
    <div>
      ...
      <Section
        ...
        // Below code will show/hide the description upon clicking the toggle button created in child component
        setIsVisible={display => {
          if (display) {
            setIsVisibleSection('about'); // assigning key to state variable with the setFunction.
          } else {
            setIsVisibleSection('');
          }
        }}
